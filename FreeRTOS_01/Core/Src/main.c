...
/* Definitions for PTask */
osThreadId_t PTaskHandle;
const osThreadAttr_t PTask_attributes = {
  .name = "PTask",
  .stack_size = 128 * 4,
...
/* USER CODE BEGIN Header_PTaskHook */
/**
* @brief Function implementing the PTask thread.
* @param argument: Not used
* @retval None
*/
